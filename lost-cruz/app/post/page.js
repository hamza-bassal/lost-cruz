...
const contactInfoPatterns = [
  ...
  /\d{3}\.\d{3}\.\d{3}\.\d{3}\.\d{3}\.\d{3}/,
  /\d{3} \d{3} \d{3} \d{3} \d{3} \d{3}/,
  /\d{1,5}\s[A-Za-z0-9\s]+(?:Ave|Avenue|St|Street|Rd|Road|Blvd|Boulevard|Dr|Drive|Ct|Court|Ln|Lane|Way)\.?/,
];
...
const PostPage = () => {
  const description =
    "I live at 123 Fake Street. Call me at 123-456-7890. This is a badword1 and badword2 example.";
